...
Проект предоставлятся "как есть" для личного, не коммерческого пользования.
...
Это может быть полезно для проверски связи с удаленным координатором. Данный сброс не нарушает работы устройства.
